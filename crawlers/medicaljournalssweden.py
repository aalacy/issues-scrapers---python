...
from util import fetch_url, create_dir, export_csv, read_csv_data, download_pdfs_via_thread

max_workers = 2

domain = "https://medicaljournalssweden.se"
...
csv_name = "medicaljournalssweden"
csv_data = []
pdfs = []
file_paths = []
failed_files = []
...
links = [
    "https://medicaljournalssweden.se/jrm/issue/archive"
]
